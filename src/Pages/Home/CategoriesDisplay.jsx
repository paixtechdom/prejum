...
export const CategoriesDisplay = () => {
    ...
    return(
        <div className="flex justify-center items-center w-full text-gray-200 py-9 mt-9 border-b border-gray-500">
            <div className="flex flex-col justify-between xl:w-9/12 w-11/12 items-center transition-all duration-1000 md:gap-9 gap-9 md:flex-row h-full my-9">
            <div className={`rounded-full border border-2 relative flex justify-center items-center w-full`} style={{
                    width: 300+'px',
                    height: 300+'px',
                    borderColor: 'rgb(225, 225, 225, 0.1)'
                }}>
                    <div className="flex absolute text-gray-200 text-xl opacity-40">
                        BLOG CATEGORIES
                    </div>
                ...
                <div className="flex flex-col h-full w-full md:w-6/12 justify-between items-center gap-3 text-center md:items-right mt-9 md:mt-0 overflow-hidden">
                    ...
                    <div className="w-full">
                        <div className="w-full" style={{
                            ...
                            <div className="transition-all duration-1000 flex flex-row-reverse" style={{
                                ...
                                {
                                    Categories.map((cat, key) => (
                                        <p key={key} className="text-gray-300 w-full px-4">{cat.desc}</p>

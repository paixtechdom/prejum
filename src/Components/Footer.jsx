...
export const Footer = () => {
    return(
        <div className="flex justify-center items-center w-full text-gray-200 py-9 bg-gray-900">
            <div className="flex justify-between md:w-9/12 w-11/12 items-center transition-all duration-500 gap- flex-col ">
            <div className="py-9 my-9 flex w-full">
                <ContactForm />
            </div>
                ...
                <div className="text-gray-300 flex flex-col items-center text-center">
                    ...
                    <div className="flex items-center gap-2">
                        &copy; Copyright @ <Link to={"/"} className="text-xl text-pink-900">PREJUM</Link> 2024
                    </div>
                </div>
            </div>
        </div>
